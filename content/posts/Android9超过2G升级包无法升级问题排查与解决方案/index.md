...
draft = false
title = 'Android9超过2G升级包无法升级问题排查与解决方案'
tags = ['Android', '升级']
summary= "Android9超过2G升级包无法升级问题排查与解决方案"
...
制作一个超过2G的升级包，并通过imhex工具查看升级包、zipinfo命令查看压缩包信息，均发现payload.bin在压缩包的偏移量为47，但是通过python打印出来的是67。
